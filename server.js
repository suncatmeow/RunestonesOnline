...
// --- SUNCAT VOCAL COMPOSER (For Ai3Module) ---
    socket.on('suncat_compose_vocal', async (data, callback) => {
        ...
        try {
            ...
            3. In the [LYRICS] tag, YOU MUST WRITE LYRICS. Provide a short, poetic phrase (max 3 words). 
            You MUST separate every sung syllable with a hyphen '-'. 
            Example: [LYRICS] The-stars-fall-down [/LYRICS] or [LYRICS] O-ce-an-breeze [/LYRICS].           
